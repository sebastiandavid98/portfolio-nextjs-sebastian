              ...
              <div className="flex flex-col flex-1 p-5">
                ...
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {project.tech.map((tech) => (
                    <span key={tech} className="bg-gray-100 dark:bg-slate-700/60 text-gray-600 dark:text-slate-300 text-xs font-medium px-2.5 py-1 rounded-md border border-gray-200 dark:border-slate-600/40">
                      {tech}
                    </span>
                  ))}
                </div>
